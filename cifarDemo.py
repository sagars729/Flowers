...
with tf.Session() as sess:
    ...
    try: saver.restore(sess,'./models/cifar_model_final.ckpt')
    except:
    ...
    for i in range(STEPS):
        ...
        if(i%SKIP==0): 
            print(i)
            save_path = saver.save(sess,"./models/cifar_model.ckpt")
    save_path = saver.save(sess,"./models/cifar_model_final.ckpt")
    test(sess)
